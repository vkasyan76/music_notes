...
lilypond_binary = os.path.join('/home/lily/lilypond-2.24.4/release/binaries/mingw/lilypond/install/bin', 'lilypond')
...
if '/home/lily/lilypond-2.24.4/release/binaries/mingw/lilypond/install/bin' == ('@' + 'bindir@') or not os.path.exists(lilypond_binary):
